...
if st.button("Predict"):
    ...
    # ---------------- RESULT ----------------
    if prediction[0] == 1:
        st.markdown('<div class="result-box error">Cardio Disease Detected</div>', unsafe_allow_html=True)
    else:
        st.markdown('<div class="result-box success">Healthy - No Cardio Disease</div>', unsafe_allow_html=True)
